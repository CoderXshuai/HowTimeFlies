...
public class TimeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = root.findViewById(R.id.tv_type);
        //下面的this部分，在IDE里是有红色波浪线的，但是是可以编译的
...
//    BarChart barChart;
//    @BindView(R.id.time_rec_view)
//    RecyclerView timeRecView;
...
//        Time time = new Time("学习类", 22, 2, 30, "https://www.jianshu.com/p/9e6848aeeeee");
//        for (int i = 0; i < 5; i++) {
//            times.add(time);
//        }
//    }
...
//        timeRecView.setLayoutManager(layoutManager);
//        //加载适配器
//        TimeAdapter adapter = new TimeAdapter(times, getActivity());
